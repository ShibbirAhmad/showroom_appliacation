      ...
      <div class="container">
        ...
        <ul class="breadcrumb">
          <li
            ...
            v-if="sub_sub_category.slug==$route.params.slug"
          >
            <router-link
        ...
        <div class="row">
          ...
          <aside id="column-left" class="col-sm-3 hidden-xs">
            ...
            <div class="box-category">
              <ul id="cat_accordion">
                ...
                >
                  <router-link
                    :to="{name:'sub_sub_category', params: { slug: sub_sub_category.slug }}"
          ...
          <div id="content" class="col-sm-9">
            ...
            <br />
            <div class="row products-category product-content">
              <div
                class="col-lg-3 col-md-3 col-xs-6 product_container_column"
                ...
                <div class="product-thumb">
                  <div class="image">
                    <router-link :to="{ name: 'single', params: { slug: product.slug }}">
                      <!-- <img
                      v-if="product.product_imag.length > 0"
