<template>
  <div class="login-box" v-if="!isLoading">
    <div class="login-logo">
      <a href="#"> <b>welcome to outlet</b> </a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      ...
      <form @submit.prevent="login">
        ...
        <router-link class="span password_reset_button" :to="{name : 'manager_password_reset'}">Forgotten Password</router-link>
      ...
      this.form
        ...
        .then((resp) => {
          ...
          if (resp.data.status == "SUCCESS") {
            ...
            this.$store.commit("manager", resp.data.manager);
