...
class ShowroomCredit extends Model
{
      ...
      public static function Balance(){
        ...
        $all_credit_item=ShowroomCredit::all();
        ...
        $today_credit_item=ShowroomCredit::where('date', '>=', Carbon::today()->startOfDay())
        ...
        $total_debit_item=ShowroomDebit::all();
        ...
        $today_debit_item=ShowroomDebit::where('date', '>=', Carbon::today()->startOfDay())
                                        ->where('date', '<=', Carbon::today()->endOfDay())
                                        ->get();
