            ...
            <div class="col-lg-11">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <div class="row">
                    <div class="col-lg-1">
                      <select class="form-control" v-model="item" @change="productList()">
                    ...
                    <div class="col-lg-2">
                      <select class="form-control" v-model="status" @change="productList">
                    ...
                    <tbody>
                      ...
                      <tr v-for="(product,index) in products.data" v-else>
                        ...
                        <td style="width: 100px;">
                          <p v-html="product.product_barcode.barcode" class="barcode"></p>
                          <span class="barcode-number">{{product.product_barcode.barcode_number}}</span>
                        </td>
                        ...
                        <td>
                          ...
                          >{{product.stock}}</span>
                          <span v-else class="badge badge-success">{{product.stock}}</span>
                        </td>
                        <td>
                          <span class="badge badge-success" v-if="product.status==1">Approved</span>
                          <span class="badge badge-primary" v-else-if="product.status==2">Pending</span>
                          <span class="badge badge-warning" v-else>Deny</span>
                        </td>
                        <td>
                          <i class="fa fa-bars" @click="changeDisplay(product)"></i>
                ...
                <div class="box-footer">
                  <div class="row">
                    <div class="col-lg-6">
                      <pagination :limit="4" :data="products" @pagination-change-page="productList"></pagination>
                    </div>
