                ...
                <div class="row">
                  <div class="col-lg-2">
                    <div class="form-group">
                      ...
                      >
                        <option value="1">Office Sale</option>
                        <option value="2">Company Sale</option>
                      </select>
...
export default {
  ...
  methods: {
    ...
    finalValidation() {
      ...
      if (this.form.type == 1 && this.form.name.length <= 0) {
        this.submitValidation = true;
        return;
      }
      if (this.form.type == 1 && this.form.mobile_no.length != 11) {
        this.submitValidation = true;
        return;
      }
      if (this.form.type == 1 && this.form.address.length <= 0) {
        this.submitValidation = true;
        return;
      }
      if (this.form.type == 2 && this.form.company_id.length <= 0) {
        this.submitValidation = true;
        return;
      }

      if (this.form.type == 2 && this.form.invoice_no.length <= 0) {
        this.submitValidation = true;
        return;
      }
