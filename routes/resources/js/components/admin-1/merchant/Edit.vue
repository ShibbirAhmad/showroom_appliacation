    ...
    <div>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    <router-link :to="{name:'merchant'}" class="btn btn-primary"><i class="fa fa-arrow-right"></i></router-link>
                </h1>
                <ol class="breadcrumb">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getMerchant() {
                axios.get('/edit/merchant/' + this.$route.params.id)
                    .then((resp) => {
            ...
            update() {
                ...
                this.form.post('/update/merchant/' + this.$route.params.id, {
