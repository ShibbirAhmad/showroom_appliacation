                      ...
                      <table class="table">
                        ...
                        <tbody v-if="products.length > 0">
                          <tr v-for="(product, index) in products" :key="index">
                            ...
                            <td>
                              <a class="btn btn-danger btn-sm" @click="remove(index)"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
...
export default {
  ...
  methods: {
    ...
    totalCalculation() {
      ...
      this.form.due =this.form.total-(parseInt(this.form.discount)+parseInt(this.form.paid)) + this.form.shipping_cost;
    },
