                ...
                <div class="box-body">
                  <div class="row">
                    <div class="invoice-header">
                      ...
                      />
                      <div class="address">
                        <p>Office: Houes:36,Road:06,Benaroshi Polli,Mirpur-10,Dhaka-1216.</p>
                        <p>EmaiL:madinafashion2017@gmail.com</p>
                  ...
                  <div class="row">
                    <div class="col-lg-4 invoice-body" style="margin-left:27px;">
                      ...
                      <p class="text-bold" >Address: {{order.customer.address +', ' + order.city.name}}</p>
                      <p class="text-bold">
                        Invoice:
                       ...
                       <p class="text-bold">
                        Courier:
                        <strong v-if="order.courier.name">{{order.courier.name}}</strong>
                      </p>
                       <p class="text-bold">
                        Memo_no:
                        <strong v-if="order.memo_no">{{order.memo_no}}</strong>
                      </p>
