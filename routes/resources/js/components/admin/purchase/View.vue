                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    <div class="col-lg-4 invoice-body" style="margin-left:27px;">
                      <div v-if="merchant">
                      <p class="text-bold">Supplier Name: {{merchant.name}}</p>
                       <p class="text-bold">Suplier Company: {{merchant.company_name}}</p>
                      <p class="text-bold">Suplier Phone: {{merchant.phone}}</p>
                      <p
                        class="text-bold"
